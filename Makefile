...
.PHONY: build nube nube-cli nube-help help fmt fmt-check lint test ci tools
.PHONY: worker-ci
...
LDFLAGS := -X github.com/gberlati/nube-cli/internal/cmd.version=$(VERSION) -X github.com/gberlati/nube-cli/internal/cmd.commit=$(COMMIT) -X github.com/gberlati/nube-cli/internal/cmd.date=$(DATE)
...
#   make nube-cli -- --help
ifneq ($(filter nube-cli nube,$(MAKECMDGOALS)),)
...
fmt: tools
	@$(GOIMPORTS) -local github.com/gberlati/nube-cli -w .
	@$(GOFUMPT) -w .
